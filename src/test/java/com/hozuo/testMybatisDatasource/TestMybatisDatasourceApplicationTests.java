...
@SpringBootTest(classes = TestMybatisDatasourceApplication.class)
//测试环境使用，用来表示测试环境使用的ApplicationContext将是WebApplicationContext类型的
@WebAppConfiguration
public class TestMybatisDatasourceApplicationTests {
	...
	public void getHello() throws Exception{
		...
		MvcResult mvcResult= mockMvc.perform(MockMvcRequestBuilders.get("/insert")
